...
import HotelPageUser from "../views/pages/user/HotelPageUser";
import NotFoundPage from "../views/pages/user/NotFoundPage";
import NodePage from "../views/pages/admin/NodePage";

import OfflinePage from "../views/pages/user/OfflinePage";
import BobotHotelPage from '../views/pages/admin/BobotHotelPage';
