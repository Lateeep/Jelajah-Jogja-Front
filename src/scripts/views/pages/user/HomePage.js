...
const HomePage = {
    ...
    return `
      ...
      <div class="container-fluid category">
        ...
        >
          ...
          >
            <div class="card kategori_card">
              <a href="#/penginapan" class="nav-link d-flex justify-content-center flex-column align-items-center">
  ...
  async afterRender() {
    ...
    // Pastikan elemen tidak null sebelum mengatur innerHTML
    if (destinasiPopulerContainer_left && destinasiPopulerContainer_right) {
      ...
      console.error("Elemen tidak ditemukan: Pastikan ID yang digunakan benar.");
    }
    // top penginapan
